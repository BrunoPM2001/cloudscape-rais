...
export default function Paso1({ data, loading }) {
  //  States
            ...
            <SpaceBetween size="s">
              ...
              >
                <Select
                  ...
                  statusType={lineas.length == 0 ? "loading" : "finished"}
              ...
              <ColumnLayout columns={3}>
                ...
                >
                  <Select
                    placeholder="Escoja una opción"
                    statusType={ocde.length == 0 ? "loading" : "finished"}
                    loadingText="Cargando datos"
                    options={ocde.filter((item) => item.parent_id == null)}
                    selectedOption={formValues.ocde_1}
                    onChange={({ detail }) => {
                      handleChange("ocde_1", detail.selectedOption);
                      if (detail.selectedOption != formValues.ocde_1) {
                ...
                >
                  <Select
                    placeholder="Escoja una opción"
                    statusType={
                      formValues.ocde_1 == null ? "loading" : "finished"
                    }
                    ...
                    options={
                      formValues.ocde_1 == null
                        ? []
                        : ocde.filter(
                            (item) => item.parent_id == formValues.ocde_1?.value
                          )
                    }
                    selectedOption={formValues.ocde_2}
                    onChange={({ detail }) => {
                      handleChange("ocde_2", detail.selectedOption);
                      if (detail.selectedOption != formValues.ocde_2) {
                        handleChange("ocde_3", null);
                      }
                    }}
                  />
                ...
                >
                  <Select
                    placeholder="Escoja una opción"
                    statusType={
                      formValues.ocde_2 == null ? "loading" : "finished"
                    }
                    ...
                    options={
                      formValues.ocde_2 == null
                        ? []
                        : ocde.filter(
                            (item) => item.parent_id == formValues.ocde_2?.value
                          )
                    }
            ...
            <ColumnLayout columns={3}>
              ...
              >
                <Input
                  ...
                  onChange={({ detail }) =>
                    handleChange("financiamiento_fuente_externa", detail.value)
                  }
                />
              </FormField>
              <FormField
            ...
            <ColumnLayout columns={3}>
              <FormField label="Fuente financiadora" stretch>
                <Select
                  ...
                  onChange={({ detail }) =>
                    handleChange("fuente_financiadora", detail.selectedOption)
                  }
                />
              </FormField>
              ...
              <FormField label="La UNMSM participa como" stretch>
                <Select
                  ...
                  onChange={({ detail }) =>
                    handleChange("participacion_unmsm", detail.selectedOption)
                  }
                />
              </FormField>
