...
import AsesorTesista from "./asesorTesista";
...
export default function Detalle_proyecto_ptpdocto() {
  //  State
  ...
  const tabs = [
    ...
    {
      id: "asesorTesista",
      label: "Asesor/Tesista",
      content: (
        <AsesorTesista data={data.responsableTesista} loading={loading} />
      ),
    },
  ];
