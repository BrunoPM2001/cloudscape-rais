...
const FILTER_PROPS = [
  ...
  {
    propertyLabel: "Laboratorio",
    key: "laboratorio",
    groupValuesLabel: "Laboratorios",
    operators: stringOperators,
  },
  {
...
const columnDefinitions = [
  ...
  },
  {
    id: "categoria_uso",
    header: "Categoría",
    cell: (item) => item.categoria_uso,
    sortingField: "categoria_uso",
  },
];
  ...
  return (
    <Table
      ...
      filter={
        <PropertyFilter
          {...propertyFilterProps}
          filteringPlaceholder="Buscar laboratorio"
