...
export default forwardRef(function (props, ref) {
  ...
  const getData1 = async () => {
    const res = await axiosBase.get("investigador/convocatorias/picv/datosPaso1", {
      params: {
  ...
  const getData = async () => {
    const res = await axiosBase.get(
      "investigador/convocatorias/picv/getDataToPaso1"
    );
    const data = res.data;
    setData(data.data);
  ...
  const updateOds = async (value) => {
    ...
    const res = await axiosBase.get("investigador/convocatorias/picv/getOds", {
      params: {
  ...
  const updateOcde2 = async (value) => {
    ...
    const res = await axiosBase.get("investigador/convocatorias/picv/getOcde", {
      params: {
        parent_id: value,
      },
    });
  ...
  const registrar = async () => {
    if (validateForm()) {
      if (props.proyecto_id != null) {
        await axiosBase.post("investigador/convocatorias/picv/registrarPaso1", {
          ...formValues,
          proyecto_id: props.proyecto_id,
        });
        ...
        const res = await axiosBase.post(
          "investigador/convocatorias/picv/registrarPaso1",
          formValues
        );
        const data = res.data;
