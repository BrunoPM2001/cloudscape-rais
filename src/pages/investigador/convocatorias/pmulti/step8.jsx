...
export default function Registro_pmulti_8() {
  //  Url
  ...
  const getData = async () => {
    ...
    const res = await axiosBase.get(
      "investigador/convocatorias/pmulti/verificar8",
      {
        params: {
          id,
        },
  ...
  const reporte = async () => {
    ...
    const res = await axiosBase.get(
      "investigador/convocatorias/pmulti/reporte",
      {
        params: {
          id,
        },
  ...
  const enviar = async () => {
    if (checked) {
      ...
      const res = await axiosBase.post(
        "investigador/convocatorias/pmulti/enviar",
        {
          id,
        }
      );
