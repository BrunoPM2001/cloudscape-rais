...
export default function Registrar_proyecto_fex_2() {
    ...
    if (detail.requestedStepIndex > 1) {
      if (validateForm()) {
        ...
        if (
          ...
          setLoading(true);
          await axiosBase.post("investigador/actividades/fex/registrarPaso2", {
            ...formValues,
            id,
          });
          setLoading(false);
  ...
  const getData = async () => {
    const res = await axiosBase.get("investigador/actividades/fex/datosPaso2", {
      params: {
        id,
      },
    });
  ...
  return (
    ...
    >
      <Wizard
        ...
        allowSkipTo={formValues?.estado == 2}
        i18nStrings={{
          optional: "",
        }}
        steps={[
          ...
          {
            title: "Documentos",
            isOptional: formValues?.estado == 2,
          },
          {
            title: "Integrantes",
            isOptional: formValues?.estado == 2,
