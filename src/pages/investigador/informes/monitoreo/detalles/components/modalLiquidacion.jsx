...
const formRules = {
  prestador: { required: false },
  numero_doc: { required: true },
...
export default ({
  ...
  const subirComprobante = async () => {
    if (
      ...
      formData.append("prestador", formValues.prestador);
      formData.append("numero_doc", formValues.numero_doc);
            ...
            <ColumnLayout columns={2}>
              <SpaceBetween size="m">
                <FormField
                  label="Prestador"
                  stretch
                  errorText={formErrors.prestador}
                >
                  <Input
                    disabled={justview}
                    placeholder="Ingrese el nombre del prestador"
                    value={formValues.prestador}
                    onChange={({ detail }) =>
                      handleChange("prestador", detail.value)
                    }
                  />
                </FormField>
                <FormField
              ...
              <SpaceBetween size="m">
                <FormField
                  label="DNI"
                  stretch
                  errorText={formErrors.numero_doc}
                >
                  <Input
                    disabled={justview}
                    placeholder="N° de dni"
                    value={formValues.numero_doc}
                    onChange={({ detail }) =>
                      handleChange("numero_doc", detail.value)
                    }
                  />
                </FormField>
