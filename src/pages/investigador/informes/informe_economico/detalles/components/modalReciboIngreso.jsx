...
const formRules = {
  ...
  fecha: { required: true },
  fecha_presentacion_solicitud_compra: { required: false },
...
export default ({
  ...
  const subirComprobante = async () => {
    if (
      ...
      formData.append(
        "fecha_presentacion_solicitud_compra",
        formValues?.fecha_presentacion_solicitud_compra ?? ""
      );
  ...
  return (
    <Modal
      ...
      header="Recibo de ingreso por devolución (por menor gasto)"
    >
      {opts == null ? (
        ...
        <Form>
          <SpaceBetween size="m">
            <ColumnLayout columns={2}>
              <SpaceBetween size="m">
                <FormField label="Razón social" stretch>
                  <Input value={formValues.razon_social} readOnly disabled />
                </FormField>
                <FormField
                ...
                <FormField
                  label="Fecha de presentación de solicitud de compra"
                  stretch
                  errorText={formErrors.fecha_presentacion_solicitud_compra}
                >
                  <DatePicker
                    disabled={justview}
                    placeholder="YYYY-MM-DD"
                    value={formValues.fecha_presentacion_solicitud_compra ?? ""}
                    onChange={({ detail }) =>
                      handleChange(
                        "fecha_presentacion_solicitud_compra",
                        detail.value
              ...
              <SpaceBetween size="m">
                <FormField label="RUC del emisor" stretch>
                  <Input value={formValues.ruc} disabled readOnly />
                </FormField>
