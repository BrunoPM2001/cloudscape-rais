        ...
        <Modal
            ...
            footer={
                <Box float="right">
                    ...
                    <Button variant="primary" loading={loadingEliminando} onClick={() => { eliminarFiliacion(); close(); }}>Eliminar</Button>
                </Box>
            }
        >
            <SpaceBetween size="m">
                ...
                >
                    ...
                    futuras acciones del investigador. Asegúrate de que realmente deseas continuar.
                </Alert>
            </SpaceBetween><br />
            <b><p>¿Estás seguro de que deseas eliminar esta publicación?</p></b>
