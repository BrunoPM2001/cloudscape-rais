...
const Revistas_editores_registrar = lazy(
  () =>
    import("../pages/investigador/publicaciones/revistas_editores/registro.jsx"),
);
const Revistas_editores = lazy(
  () =>
    import("../pages/investigador/publicaciones/revistas_editores/index.jsx"),
);
...
const Presentar_informe = lazy(
  () =>
    import("../pages/investigador/informes/informe_academico/presentacion/index.jsx"),
);
...
const Proyectos_con_financiamiento = lazy(
  () =>
    import("../pages/investigador/actividades/proyectos_con_financiamiento/index.jsx"),
);
const Proyectos_sin_financiamiento = lazy(
  () =>
    import("../pages/investigador/actividades/proyectos_sin_financiamiento/index.jsx"),
);
  ...
  [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "revistas_editores",
          children: [
            {
              path: "",
              element: <Revistas_editores />,
            },
            {
              path: "registrar",
              element: <Revistas_editores_registrar />,
            },
          ],
        },
      ],
